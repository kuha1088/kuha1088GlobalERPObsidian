...
- [ ] 247592D Добавить возможность мнеять summaryFormat у атрибута в гриде
	...
	#КучеровскийДанил 
	#ТимофеевИгорь
- [ ] 256364D - MTP_DEV-3590. ЧТЗ №18. Доработка учета НДС в количестве позиций ценовых услуг
	#ТитовВадим 
	#ЛевченкоАндрей
- [ ] 257154D -MTP_DEV-3500. Доработка операции обработки в сессии э/э. Автоматический подбор потребности. Проектно СНГ
	#ТитовВадим 
	#ЛевченкоАндрей
...
- [ ] 247950D - MTP_DEV-2339. Доработка ФН "Требовать обязательного указания подразделения-заявителя при создании акта"
	#ТитовВадим 
	#КошутинПавел
- [ ] 251586D - MTP_DEV-2913. Реализация процедуры БП (ZSngStm_ActIn) для проверки полноты распределения услуг на потребности. Проектно СНГ
	#ТитовВадим
	#КозловскийЯрослав
	#КосенкоКирилл
- [ ] 251932D - MTP_DEV-3508. Реализация ФН для обновления даты принятия от входящей даты в приходном акте. Базово.
	#ТитовВадим 
	#ХасановИльшат
- [ ] 253844D - MTP_DEV-3530. Доработка расчетов сумм в позициях акта при создании от сессии загрузки э/э. Проектно СНГ
	#ТитовВадим 
	#ЛевченкоАндрей
